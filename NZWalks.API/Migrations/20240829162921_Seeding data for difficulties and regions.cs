    ...
    public partial class Seedingdatafordifficultiesandregions : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("63a7d3a2-6fab-4af8-b795-dc3a7c213fb9"), "Hard" },
                    { new Guid("affd1af1-4dea-4154-879d-572803e2cd22"), "Medium" },
                    { new Guid("c49b622f-d938-4a6a-a8c5-fdc7b8db4c23"), "Easy" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("63a7d3a2-6fab-4af8-b795-dc3a7c213fb9"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("affd1af1-4dea-4154-879d-572803e2cd22"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "Id",
                keyValue: new Guid("c49b622f-d938-4a6a-a8c5-fdc7b8db4c23"));
